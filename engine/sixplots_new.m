function sixplots(gas)
    ...
    title(strcat(gas, ' Standard Timing, Varying RPM'))
    xlabel("RPM (1/min)")
    ...
    title(strcat(gas, ' Standard Timing, Varying Throttle'))
    xlabel("Throttle (%)")
    ylabel("Concentration (ppm)")
    ...
    title(strcat(gas, ' Constant Throttle = 50%, Varying Timing'))
    ...
    legend('50% thr.', '75% thr.', '100% thr.', 'Location','northwest')
    title(strcat(gas, ' Retarded Timing, Varying RPM'))
    xlabel("RPM (1/min)")
    ylabel("Concentration (ppm)")
    ...
    title(strcat(gas, ' Retarded Timing, Varying Throttle'))
    xlabel("Throttle (%)")
    ylabel("Concentration (ppm)")
    ...
    legend('2000 RPM', '3000 RPM', '4000 RPM', 'Location','northwest')
    title(strcat(gas, ' Constant Throttle = 75%, Varying Timing'))
    xlabel("Ignition timing (normalized)")
    ylabel("Concentration (ppm)")
    ...
    plotvary(gas, 2000:1000:4000, 100, 1);
    legend('50% thr.', '75% thr.', '100% thr.', 'Location','northwest')
    title(strcat(gas, ' Advanced Timing, Varying RPM'))
    xlabel("RPM (1/min)")
    ylabel("Concentration (ppm)")
    ...
    plotvary(gas, 4000, 50:25:100, 1); 
    legend('2000 RPM', '3000 RPM', '4000 RPM', 'Location','northwest')
    title(strcat(gas, ' Advanced Timing, Varying Throttle'))
    xlabel("Throttle (%)")
    ylabel("Concentration (ppm)")
    ...
    legend('2000 RPM', '3000 RPM', '4000 RPM', 'Location','northwest')
    title(strcat(gas, ' Constant Throttle = 100%, Varying Timing'))
    xlabel("Ignition timing (normalized)")
    ylabel("Concentration (ppm)")
